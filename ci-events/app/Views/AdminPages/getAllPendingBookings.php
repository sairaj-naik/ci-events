                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-data">
                                ...
                                <div class="field-block">
                                    <label>Number of Seats Alloted:</label>
                                    <input type="number" name="Email"  id="seatstxt" class="form-control form-control-lg"/>
                                </div>

                                <div class="modal-footer">
                                    <button id="add-user" class="btn btn-success">Add User</button>
                                    <button id="approve-booking" class="btn btn-warning">Approve Booking</button>
