...
<body id="index">
        ...
        <div class="container">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-data">
                                    ...
                                    <div class="field-block">
                                        ...
                                        <input type="text" name="details"  id="eventdetailstxt" class="form-control form-control-lg"/>
                                    </div>

                                    <div class="field-block">
                                        <label>Event Date:</label>
                                        <input type="date" name="date"  id="eventdate" class="form-control form-control-lg"/>
                                    </div>

                                    <div class="field-block">
                                        <label>Number of Participants:</label>
                                        <input type="number" name="nop"  id="nop" class="form-control form-control-lg"/>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button id="add-user" class="btn btn-success">Create Event</button>
                                        <button id="update-event" class="btn btn-warning">Update Event</button>
            ...
            <div class="block-above-datatable">
                <button id="create-user-btn" class="btn btn-dark">Create Event</button>
            </div>
